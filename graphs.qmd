...
`data`, `scripts` and `figs`. WHERE TO FIND DATA.

<!-- ### A new script -->
<!-- Click on `File > New File > R Script`. -->
<!-- Start the new script with the following two lines: -->
...
default choices; we could override those, but that'll be for later. 
...
## Putting it all together (I): Portuguese reading and writing skills
...
I suggest you check out Lukas Sönning's [_The dot plot: A graphical tool for data analysis and presentation](https://doi.org/10.20378/irbo-51101),
